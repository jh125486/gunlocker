...
- (void)viewDidLoad {
    ...
    if (!self.root) {
        ...
        QDateTimeInlineElement *formSentDateElement = [[QDateTimeInlineElement alloc] initWithTitle:@"Form Sent" date:stamp.form_sent andMode:UIDatePickerModeDate];
        formSentDateElement.key = @"form_sent";
        
        QDateTimeInlineElement *checkCashedDateElement = [[QDateTimeInlineElement alloc] initWithTitle:@"Check Cashed" date:stamp.check_cashed andMode:UIDatePickerModeDate];
        checkCashedDateElement.key = @"check_cashed";
        
        QDateTimeInlineElement *wentPendingDateElement = [[QDateTimeInlineElement alloc] initWithTitle:@"Went Pending" date:stamp.went_pending andMode:UIDatePickerModeDate];
        wentPendingDateElement.key = @"went_pending";
        
        QDateTimeInlineElement *stampReceivedDateElement = [[QDateTimeInlineElement alloc] initWithTitle:@"Stamp Received" date:stamp.stamp_received andMode:UIDatePickerModeDate];
