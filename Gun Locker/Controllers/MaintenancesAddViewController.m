...
- (void)viewDidLoad {
    ...
    QDateTimeInlineElement *maintenanceDate = [[QDateTimeInlineElement alloc] initWithTitle:@"Date" date:[NSDate date] andMode:UIDatePickerModeDate];
    maintenanceDate.mode = UIDatePickerModeDate;
    maintenanceDate.key = @"date";
    
    QDecimalElement *roundCount = [[QDecimalElement alloc] initWithTitle:@"Round Count" value:_selectedWeapon.round_count];
