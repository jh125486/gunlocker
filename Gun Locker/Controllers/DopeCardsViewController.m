...
-(void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString *_detailText = [NSString stringWithFormat:@"Zero: %@ %@", dopeCard.zero, [dataManager.rangeUnits objectAtIndex:[dopeCard.zero_unit intValue]]];
    if (dopeCard.wind_info) {
        _detailText = [_detailText stringByAppendingFormat:@" / Wind: %@", dopeCard.wind_info];
    }
