...
@synthesize tempString, altitudeString, pressureString, windInfoString, targetInfoString;
...
- (void)viewDidLoad {
    ...
    self.targetInfoLabel.text = self.targetInfoString;
...
- (IBAction)saveTapped:(id)sender {
    ...
    newDopeCard.wind_info = self.windInfoString;
    
    
    newDopeCard.lead_info = self.targetInfoString;
